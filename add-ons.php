					...
					<div class="row flex-row-reverse">
						...
						<div class="col-12 col-lg-9 servicetxtDetail mb-8 mb-sm-10 mb-lg-0">
							<header class="header text-center font-weight-light mb-3 px-md-10 px-xl-10 px-xxl-15">
								<h1 class="headingI text-capitalize mb-3 fwEbold">Add Ons</h1>
							...
							<div class="imgWRoundWrap mb-5 mb-md-7 mt-n1">
								...
								<div class="imgHolder rounded w-100">
									<img src="./images/add- ons.jpg" class="img-fluid" alt="image description">
								</div>
							</div>
						...
						<div class="col-12 col-lg-3">
							...
							<div class="widget mb-6">
								...
								<li class="active"><a class="d-block" href="add-ons.php">	ADD-ONS<span class="ml-2 text-white ico fas fa-caret-right"></span></a></li>
