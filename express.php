					...
					<div class="row flex-row-reverse">
						...
						<div class="col-12 col-lg-9 servicetxtDetail mb-8 mb-sm-10 mb-lg-0">
							...
							<div class="row mb-1">
								<div class="col-12">
									<!-- planFullList -->
									<article class="active planFullList mb-5 mb-sm-8 overflow-hidden rounded">
										<!-- priceHeader -->
										<header class="bg-primary priceHeader text-white px-3 text-capitalize">
											<div class="row align-items-center">
												<div class="col-8">
													<h2 class="ml-md-3 mb-0 text-white headingIX">QUICK WASH</h2>
												</div>
												<div class="col-4 text-right">
													<h3 class="text-white headingIX fwSemibold mb-0">$6.99</h3>
												</div>
											</div>
										</header>
								...
								<div class="col-12">
									...
									<article class="planFullList mb-5 mb-sm-8 overflow-hidden rounded">
										...
										<header class="bg-primary priceHeader px-3 text-capitalize">
											<div class="row align-items-center">
												<div class="col-8">
													<h2 class="ml-md-3 mb-0 headingIX text-white">BEST EXTERIOR WASH</h2>
												</div>
												<div class="col-4 text-right">
													<h3 class="text-white headingIX fwSemibold mb-0">$14.99 </h3>
												</div>
											</div>
										</header>
										<div class="txtWrap px-3 px-md-6 pt-4 pb-7">
